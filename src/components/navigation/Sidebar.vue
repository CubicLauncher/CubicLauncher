...
<template>
    <div
        class="flex flex-col items-center h-full p-2 border-r border-stone-700"
    >
        <!-- Logo -->
        <div
        ...
        <div class="flex-1 w-full relative overflow-hidden">
            <div
                class="h-full overflow-y-auto flex flex-col items-center gap-2 scrollbar-hide"
            >
                <!-- Separator -->
                ...
                <SidebarItem
                    ...
                    :key="instance.name"
                    :name="instance.name"
                    :icon="getIcon(instance.loader.loader)"
        ...
        <div class="flex-shrink-0 w-full flex flex-col items-center gap-2">
            ...
            <div
                ...
                @mouseenter="
                    showTooltip($event, 'Launcher.sidebar.addInstance')
                "
