<template>
    <div class="flex flex-col h-full bg-stone-900 text-stone-200">
        ...
        <div class="flex-1 p-6">
            ...
            <button
                @click="handlePlay"
                class="w-full mb-6 flex items-center justify-center p-4 gap-2 bg-stone-800 rounded-lg border border-stone-600 cursor-pointer hover:bg-stone-700 transition-all"
                :style="{
                    color: colors.text,
                }"
            >
                ...
                <span class="text-lg font-medium">{{
                    languageStore.getTranslation(
                        "Launcher.views.InstanceView.PlayBtn",
                    )
                }}</span>
            </button>
...
import InstanceHeader from "./InstanceView/InstanceHeader.vue";
