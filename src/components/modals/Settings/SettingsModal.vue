<template>
    <BaseModal
        v-model="rosquilla.isSettingsModalOpen"
        :title="languageStore.getTranslation('Launcher.settings.title')"
    >
        <div class="flex">
            <!-- Vertical Tabs -->
            ...
            <div class="p-2">
                ...
                <div
                    v-else
                    class="flex items-center justify-center h-64 text-stone-400"
                >
