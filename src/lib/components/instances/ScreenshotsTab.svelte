...
<style>
    ...
    .screenshot-card:hover .overlay { opacity: 1; }
    ...
    @media (max-width: 550px) {
        .screenshots-grid { grid-template-columns: repeat(auto-fill, minmax(130px, 1fr)); gap: 8px; }
    }

    @media (max-width: 400px) {
        .screenshots-grid { grid-template-columns: repeat(auto-fill, minmax(100px, 1fr)); gap: 6px; }
    }
</style>
