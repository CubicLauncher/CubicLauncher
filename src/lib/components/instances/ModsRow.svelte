...
<style>
    ...
    @media (max-width: 700px) {
        .mods-grid { grid-template-columns: repeat(auto-fill, minmax(220px, 1fr)); }
    }

    @media (max-width: 550px) {
        .mods-grid { grid-template-columns: 1fr; gap: 8px; }
    }

    @media (max-width: 400px) {
        .mods-grid { grid-template-columns: 1fr; gap: 6px; }
    }
</style>
