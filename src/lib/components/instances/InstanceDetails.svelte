<script lang="ts">
    ...
    const isRunning = $derived(instance.status === "started" || instance.status === "starting");
    ...
    function openDir(subDir?: string) {
        invoke("open_instance_dir", { id: instance.uuid, subDir: subDir ?? null });
    }
...
<div class="details-panel">
    <div class="details-header">
        <div class="info-badges">
            ...
            <span class="badge badge-loader" style="background: {loaderColor}20; color: {loaderColor}; border-color: {loaderColor}40;">
                {instance.loader}
            </span>
        ...
        <div class="path-row">
            ...
            <button class="icon-btn" onclick={() => openDir()} title={t("instanceView.details.location")}>
    ...
    <div class="console-section">
        <div class="console-header">
            <div class="console-title">
                ...
                <span>Console {#if lines.length > 0}({lines.length}){/if}</span>
            </div>
            <div class="console-toolbar">
                ...
                <button class="toolbar-btn" onclick={copyConsole} disabled={lines.length === 0} title="Copy">
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
